...
import muckkitlist_spring.muckkitlist_spring.entity.*;
...
public class S3Uploader {
    ...
    private final MuckatUserRepository muckatUserRepository;
    ...
    @Autowired
    public S3Uploader(AmazonS3 amazonS3, @Value("${cloud.aws.s3.bucket}") String bucket, MuckatUserRepository muckatUserRepository, ReviewImageRepository reviewImageRepository, ImageRepository imageRepository, UserReviewRepository userReviewRepository, MuckatListRepository muckatListRepository) {
        this.amazonS3 = amazonS3;
        this.bucket = bucket;
        this.muckatUserRepository = muckatUserRepository;
